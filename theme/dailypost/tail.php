...
<!-- 하단 시작 { -->
    <div id="ft">
        ...
        <div class="dp-footer-brand">
            <a href="<?php echo G5_URL; ?>">DailyPost</a>
            <p>일상과 생각을 기록하는 작은 공간입니다.</p>
        </div>

        <nav class="dp-footer-links" aria-label="하단 메뉴">
        ...
        <p class="dp-copyright">
            &copy; <?php echo date('Y'); ?> DailyPost. All rights reserved.
        </p>
    </footer>
